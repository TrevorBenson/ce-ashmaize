...
// This version removes synchronous joins, allowing GPUs to work independently
...
fn main() {
    #[cfg(not(feature = "cuda"))]
    {
        ...
        eprintln!("Run with: cargo run --example multi_gpu_async --features cuda --release");
        std::process::exit(1);
    }

    #[cfg(feature = "cuda")]
    {
        println!("=== Multi-GPU Optimized: Async Execution ===\n");
        ...
        println!("\nRunning benchmark with async execution...\n");
        ...
        // Spawn GPU workers that run independently
        ...
        println!("\nOptimization: Async Execution (No Synchronous Joins)");
